...
class User(Document):
	...
	if TYPE_CHECKING:
		...
		from frappe.creche_module.doctype.user_geography_mapping.user_geography_mapping import UserGeographyMapping
		from frappe.types import DF

		allowed_in_mentions: DF.Check
		api_key: DF.Data | None
		api_secret: DF.Password | None
		app_device_id: DF.Data | None
		...
		cluster_coordinator: DF.Link | None
