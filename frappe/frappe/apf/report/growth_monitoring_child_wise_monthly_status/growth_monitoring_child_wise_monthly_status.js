frappe.query_reports["Growth Monitoring Child Wise Monthly Status"] = {
	filters: [
		{
			fieldname: "year",
			label: __("Year"),
	...
	// 	let color = "#b8b7b5"; // Default gray color

	// 	if (column.fieldname.startsWith("underweight_status_") ||
	// 		column.fieldname.startsWith("wasting_status_") ||
	// 		column.fieldname.startsWith("stuning_status_")) {
