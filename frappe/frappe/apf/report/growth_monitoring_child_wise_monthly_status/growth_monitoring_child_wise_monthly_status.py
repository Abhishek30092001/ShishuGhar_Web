...
#         # Underweight columns
#         columns.append({
#             "label": f"WFA-[{month_name} {y}]",
#             "fieldname": f"underweight_status_{year_month}",
#             "fieldtype": "Data",
#             "width": 190,
#         })
#         columns.append({
#             "fieldname": f"weight_for_age_{year_month}",
#             "hidden": 1  # Explicitly hide this column
#         })
        
#         # Wasting columns
#         columns.append({
#             "label": f"WFH-[{month_name} {y}]",
#             "fieldname": f"wasting_status_{year_month}",
#             "fieldtype": "Data",
#             "width": 180,
#         })
#         columns.append({
#             "fieldname": f"weight_for_height_{year_month}",
#             "hidden": 1
#         })
        
#         # Stunting columns
#         columns.append({
#             "label": f"HFA-[{month_name} {y}]",
#             "fieldname": f"stuning_status_{year_month}",
#             "fieldtype": "Data",
#             "width": 180,
#         })
#         columns.append({
#             "fieldname": f"height_for_age_{year_month}",
#             "hidden": 1
#         })
...
#                         AND MONTH(tad.measurement_taken_date) = {m} 
#                         AND tad.weight_for_age_zscore IS NOT NULL
#                         THEN tad.weight_for_age_zscore
#                         ELSE NULL
#                     END
...
#                         WHEN YEAR(tad.measurement_taken_date) = {y} 
#                         AND MONTH(tad.measurement_taken_date) = {m} 
#                         THEN tad.weight_for_age
#                         ELSE NULL
#                     END
#                 ) AS weight_for_age_{y}_{m:02d}
#             """)
...
#                         AND MONTH(tad.measurement_taken_date) = {m} 
#                         AND tad.weight_for_height_zscore IS NOT NULL
#                         THEN tad.weight_for_height_zscore
#                         ELSE NULL
#                     END
...
#                         WHEN YEAR(tad.measurement_taken_date) = {y} 
#                         AND MONTH(tad.measurement_taken_date) = {m} 
#                         THEN tad.weight_for_height
#                         ELSE NULL
#                     END
#                 ) AS weight_for_height_{y}_{m:02d}
#             """)
...
#                         AND MONTH(tad.measurement_taken_date) = {m} 
#                         AND tad.height_for_age_zscore IS NOT NULL
#                         THEN tad.height_for_age_zscore
#                     ELSE NULL
#                     END
...
#                         WHEN YEAR(tad.measurement_taken_date) = {y} 
#                         AND MONTH(tad.measurement_taken_date) = {m} 
#                         THEN tad.height_for_age
#                         ELSE NULL
#                     END
#                 ) AS height_for_age_{y}_{m:02d}
#             """)
...
#         -- Dynamic stunting status for last 12 months
#         ss.*,
