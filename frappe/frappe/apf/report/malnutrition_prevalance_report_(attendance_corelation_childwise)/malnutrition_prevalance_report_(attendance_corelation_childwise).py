...
def get_columns(filters=None):
    ...
    columns = [
        ...
        {"label": "HH ID", "fieldname": "hh_id", "fieldtype": "Data", "width": 150},
...
def get_summary_data(filters=None):
    ...
    LEFT JOIN 
        `tabHousehold Child Form` AS hfc ON hfc.hhcguid = cee.hhcguid
    LEFT JOIN 
        `tabHousehold Form` AS hf ON hfc.parent = hf.name
    LEFT JOIN (
